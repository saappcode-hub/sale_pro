...
class BusinessController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Create default selling price group
            $this->businessUtil->createDefaultSellingPriceGroup($business->id);

            // ✅ Create default customer group with linked selling price group
            $this->businessUtil->createDefaultCustomerGroupWithDefaultSellingGroup($business->id);

            // Create default shipping labels (Work and Home)
            $this->businessUtil->createDefaultShippingLabels($business->id);
