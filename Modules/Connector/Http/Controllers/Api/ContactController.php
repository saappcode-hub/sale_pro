...
{ 
    ...
    public function show($contact_ids)
    {
        ...
        $contacts = $query->with('contactMap')->get(); //change by Sokha CEO
        ...
        foreach ($contacts as $key => $value) {
            ...
            $contacts[$key]->contact_map = $value->contactMap->CambodiaProvince ?? null;
            $contacts[$key]->contact_map = $value->contactMap->CambodiaDistrict ?? null;
            $contacts[$key]->contact_map = $value->contactMap->CambodiaCommune ?? null;
        }
