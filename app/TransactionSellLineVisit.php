...
class TransactionSellLineVisit extends Model
{
      // Specifying the table name is optional if it follows Laravel's naming convention
      protected $table = 'transaction_sell_lines_visit';  // Only necessary if the table name cannot be guessed correctly from the model name
