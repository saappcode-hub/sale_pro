...
class TransactionReward extends Model
{
    ...
    protected $table = 'transactions_reward';  // Only necessary if the table name cannot be guessed correctly from the model name
    ...
    public function TransactionRewardSellLine()
    {
        return $this->hasMany(TransactionRewardSellLine::class, 'transaction_id', 'id');
    }
