    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('invoice_qrs_id', __('Invoice QR Code') . ':*') !!} @show_tooltip(__('Invoice QR Code'))
                        {!! Form::select('invoice_qrs_id', $invoice_qrs, $location->invoice_qrs_id, ['class' => 'form-control',
                        'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
