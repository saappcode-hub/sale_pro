      ...
      <hr>
        ...
        @endif
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'ring_report.view', in_array('ring_report.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Ring Report' ) }}
              </label>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stock_movement_report.view', in_array('stock_movement_report.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Stock Movement Report' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'daily_sales_payment_report.view', in_array('daily_sales_payment_report.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Daily Sales Payment Report' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'daily_payment_report.view', in_array('daily_payment_report.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Daily Payment Report' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'sales_report_summary.view', in_array('sales_report_summary.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Sales Report Summary' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'sales_detail_report.view', in_array('sales_detail_report.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Sales Detail Report' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'sales_order_detail_report.view', in_array('sales_order_detail_report.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Sales Order Detail Report' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'sales_details_sellers_report.view', in_array('sales_details_sellers_report.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Sales Details Sellers Report' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'report_export_center.view', in_array('report_export_center.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Report Export Center' ) }}
              </label>
            </div>
          </div>
        ...
        <div class="row check_group">
            ...
            <div class="col-md-9">
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('permissions[]', 'cash_deposit.view', in_array('cash_deposit.view', $role_permissions), 
                            [ 'class' => 'input-icheck']); !!} View Cash Deposit History
                        </label>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('permissions[]', 'cash_deposit.create', in_array('cash_deposit.create', $role_permissions), 
                            [ 'class' => 'input-icheck']); !!} Create / Add Deposit
                        </label>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('permissions[]', 'cash_deposit.edit', in_array('cash_deposit.edit', $role_permissions), 
                            [ 'class' => 'input-icheck']); !!} Edit Deposit
                        </label>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('permissions[]', 'cash_deposit.delete', in_array('cash_deposit.delete', $role_permissions), 
                            [ 'class' => 'input-icheck']); !!} Delete Deposit
                        </label>
                    </div>
                </div>
            </div>
