        ...
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false">Invoice QR</a></li>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_3">
                        <div class="row">
                            <div class="col-md-12">
                                <h4> Invoice QR <a class="btn btn-primary pull-right" href="{{action([\App\Http\Controllers\InvoiceQrsController::class, 'create'])}}">
                                        <i class="fa fa-plus"></i> @lang( 'messages.add' )</a></h4>
                            </div>
                            <div class="col-md-12">
                                @foreach( $invoice_qrs as $layout)
                                <div class="col-md-3">
                                    <div class="icon-link">
                                        <a href="{{action([\App\Http\Controllers\InvoiceQrsController::class, 'edit'], [$layout->id])}}">
                                            <i class="fa fa-file-alt fa-4x"></i>
                                            {{ $layout->name }}
                                        </a>
                                        @if( $layout->is_default )
