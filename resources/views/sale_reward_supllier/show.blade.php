  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <b>Ring Status:</b>
          @if($transaction->sub_type == 'pending')
            <span class="status-pending">Pending</span>
          @elseif($transaction->sub_type == 'send')
            <span class="status-completed">Send</span>
          @else
            <span>{{ ucfirst($transaction->sub_type) }}</span>
          @endif
        </div>
      </div>
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr class="total-row">
            ...
            <td style="text-align: right;background-color: #D2D6DE; color: black;"><strong>${{ number_format($transaction->final_total, 2) }}</strong></td>
          </tr>
        </tbody>
      </table>
