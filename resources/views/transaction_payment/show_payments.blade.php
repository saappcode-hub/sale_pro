            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        ...
                        <th>Ring Invoice No</th> {{-- New column header --}}
                        ...
                        @forelse ($payments as $payment)
                            ...
                            <td>
                                {{-- Display ring top-up reference only for cash_ring and cash_ring_percentage methods --}}
                                @if(in_array($payment->method, ['cash_ring', 'cash_ring_percentage']))
                                    @if(!empty($payment->ring_top_up_ref))
                                        {{ $payment->ring_top_up_ref }}
                                    @else
                                        <span class="label label-warning">Pending</span>
                                    @endif
                                @else
                                    {{-- Empty for other payment methods --}}
                                    -
                                @endif
                            </td>
                        ...
                        @empty
                            ...
                            <td colspan="7">@lang('purchase.no_records_found')</td> {{-- Updated colspan to 7 --}}
                            </tr>
                        @endforelse
                        </table>
                    </div>
