<div class="row">
	...
	@php
		...
		$readonly = isset($payment_line->method) && $payment_line->method == 'advance' ? true : false;
	@endphp
	
	<div class="{{$col_class}}">
		<div class="form-group">
			{!! Form::label("method_$row_index" , __('purchase.payment_method') . ':*') !!}
	...
	<div class="col-md-4">
		<div class="form-group">
			{!! Form::label("document_$row_index", __('purchase.attach_document') . ':') !!}
	...
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("note_$row_index", __('lang_v1.payment_note') . ':') !!}
