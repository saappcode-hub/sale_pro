...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#user_allowed_contacts').select2({
        ajax: {
            url: '/contacts/customers', dataType: 'json', delay: 250,
            data: function(params) { return { q: params.term, page: params.page, all_contact: true }; },
                ...
                rules: {
                    ...
                    email: {
                        ...
                        remote: {
                            ...
                            data: { email: function() { return $( "#email" ).val(); }, user_id: {{$user->id}} }
                        }
                    },
