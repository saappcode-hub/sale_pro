    ...
    <div class="col-md-4 col-sm-6">
        <div class="form-group">
            <div class="input-group">
                ...
                {!! Form::text('price_group_text', $transaction->price_group->name, ['class' => 'form-control', 'readonly', 'disabled' => true, 'style' => 'background-color: #f5f5f5; color: #666; cursor: not-allowed;']); !!}
                <span class="input-group-addon">
