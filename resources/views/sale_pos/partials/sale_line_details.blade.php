        ...
        <tr>
            ...
            <td>
                @php
                    ...
                    if (!empty($sell_line->sub_unit) && $sell_line->sub_unit_id != null) {
                        $quantity = $sell_line->quantity / $sell_line->sub_unit->base_unit_multiplier;
                    }
                @endphp
                @if(!empty($for_ledger))
                    {{ @format_quantity($quantity) }}
                @else
                    <span class="display_currency" data-currency_symbol="false" data-is_quantity="true">{{ $quantity }}</span>
                @endif
