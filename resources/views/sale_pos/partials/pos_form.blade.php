<style>
    .btn-default.bg-white.btn-flat {
        height: 34px;
    }
    .customer-details {
        margin-top: -1px; /* Remove any gap between the forms and the list */
    }
    .customer-details > div {
        border-top: none; /* Remove the top border to make it visually "stick" to the forms */
...
<div class="row">
	<div class="col-md-5">
        <div class="form-group mb-0">
            <div class="input-group">
                ...
                <input type="hidden" id="default_customer_mobile" value="{{ $walk_in_customer['mobile'] ?? ''}}">
                ...
                <span class="input-group-btn">
                    <button type="button" class="btn btn-default bg-white btn-flat edit_customer" data-id="" title="Edit Customer">
                        <i class="fa fa-edit fa-lg" style="color: #5f6368;"></i>
                    </button>
                    <button type="button" class="btn btn-default bg-white btn-flat add_new_customer" title="Add New Customer">
    ...
    <!-- Mobile and Address list spanning the full width -->
    <div class="col-md-12" style="padding-bottom: 15px;">
        <div class="customer-details" style="display: none;">
            <div style="background-color: #f5f5f5; border: 1px solid #e0e0e0; padding: 5px 8px;">
                <div class="d-flex align-items-center" style="font-size: 12px;">
                    <span><strong>Mobile:</strong> <span id="customer_mobile"></span></span>, 
                    <span><strong>Address:</strong> <span id="customer_address"></span></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="form-group">
                <div style="float: left; padding-right: 10px">
                    <span>Exchange Rate In <?php echo $currency->country;?> </span>
                </div>
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fas fa-exchange-alt"></i>
                    </span>
                    {!! Form::text('exchange_rate', $exchange_rate, ['class' => 'form-control input-sm input_number', 'placeholder' => __('lang_v1.currency_exchange_rate'), 'id' => 'exchange_rate']); !!}
                </div>
            </div>
        </div>
    {{-- @endif --}}
