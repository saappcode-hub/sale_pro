...
<?php
// dd($receipt_details->total_exchange_rate);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <!-- Total Paid-->
				@if(!empty($receipt_details->total_paid))
					<div class="flex-box">
						<p class="width-50 text-left">
							<?php
								echo 'Grand Total Dollar';
								?>
						</p>
						<p class="width-50 text-right">
							{{$receipt_details->total_paid}} <br>
				...
				<div class="flex-box">
					<p class="width-50 text-left">
						<?php echo 'Grand Total Riel'; ?>
					</p>
					<p class="width-50 text-right">
						{{"R ".number_format((float)str_replace(',', '', $receipt_details->total_exchange_rate))}} <br>
					</p>
				</div>
