<div class="pos-tab-content">
     <div class="row">
        ...
        <!-- NEW: Ring Top Up Prefix Field -->
        <div class="col-sm-4">
            <div class="form-group">
                @php
                    $ring_topup_prefix = !empty($business->ref_no_prefixes['ring_topup']) ? $business->ref_no_prefixes['ring_topup'] : '';
                @endphp
                {!! Form::label('ref_no_prefixes[ring_topup]', __('Ring Top Up') . ':') !!}
                {!! Form::text('ref_no_prefixes[ring_topup]', $ring_topup_prefix, ['class' => 'form-control']); !!}
            </div>
        </div>
    </div>
</div>