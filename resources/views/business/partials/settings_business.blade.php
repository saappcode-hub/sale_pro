<div class="pos-tab-content active">
    <div class="row">
        ...
        <!-- Payment Back-Date Days -->
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('payment_back_date', __('Payment Back-Date Days') . ':') !!}
                @show_tooltip(__('tooltip.payment_back_date'))
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                    </span>
                    {!! Form::number('payment_back_date', $business->payment_back_date, ['class' => 'form-control']); !!}
                </div>
            </div>
        </div>
        <!-- Transaction Back-Date Days -->
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('transaction_back_date', __('Transaction Back-Date Days') . ':') !!}
                @show_tooltip(__('tooltip.transaction_back_date'))
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                    </span>
                    {!! Form::number('transaction_back_date', $business->transaction_back_date, ['class' => 'form-control']); !!}
                </div>
            </div>
        </div>
        <div class="clearfix"></div>
