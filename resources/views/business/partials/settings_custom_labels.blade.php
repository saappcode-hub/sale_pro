<div class="pos-tab-content">
    ...
    <div class="clearfix"></div>
    <div class="col-sm-12">
        <h4>@lang('Label For Sale visit'):</h4>
    </div>
    <div class="col-sm-3">
        <div class="form-group">
            {!! Form::label('distant_for_salevisit', __('Distant For Sale Visit')) !!}
            <div class="input-group">
                <input type="text"
                    class="form-control"
                    id="distant_for_salevisit"
                    name="distant_for_salevisit"
                    value="{{ !empty($business->distant_for_salevisit) ? $business->distant_for_salevisit . 'm' : '0m' }}"
                    oninput="formatDistantForSaleVisit(this)">
            </div>
        </div>
    </div>
</div>
...
<script>
function formatDistantForSaleVisit(input) {
    let val = input.value.replace(/[^0-9.]/g, ''); // remove letters except dot
    if (val !== '') {
        input.value = val + 'm';
    } else {
        input.value = '';
