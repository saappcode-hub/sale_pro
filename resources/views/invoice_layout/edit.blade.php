  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('payment_lable', __('Payment label') . ':' ) !!}
            {!! Form::text('payment_lable', $invoice_layout->payment_lable, ['class' => 'form-control',
              'placeholder' => __('Payment label') ]); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('payment_due', __('Payment Due') . ':' ) !!}
            {!! Form::text('payment_due', $invoice_layout->payment_due, ['class' => 'form-control',
              'placeholder' => __('Payment Due') ]); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('payment_paid', __('Payment Paid') . ':' ) !!}
            {!! Form::text('payment_paid', $invoice_layout->payment_paid, ['class' => 'form-control',
              'placeholder' => __('Payment Paid') ]); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('payment_partial', __('Payment Partial') . ':' ) !!}
            {!! Form::text('payment_partial', $invoice_layout->payment_partial, ['class' => 'form-control',
  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('total_kh_label', 'Total KH Label' . ':' ) !!}
            {!! Form::text('total_kh_label', $invoice_layout->total_kh_label, ['class' => 'form-control',
              'placeholder' => 'Total KH Label' ]); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('qr_code_fields[]', 'piikmall_invoice', in_array('piikmall_invoice', $qr_code_fields), ['class' => 'input-icheck']); !!} @lang('Piik Mall Invoice No')</label>
        </div>
      </div>
    </div>
  </div>
