      ...
      <div class="row">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('payment_lable', old('payment_lable', __('Payment Status')), [
                    'class' => 'form-control',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('payment_due', old('payment_due', __('Due')), [
                    'class' => 'form-control',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('payment_paid', old('payment_paid', __('Paid')), [
                    'class' => 'form-control',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('payment_partial', old('payment_partial', __('Partial')), [
                    'class' => 'form-control',
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            {!! Form::text('total_kh_label', __('សរុបរួម (KHR):'), ['class' => 'form-control',
