        ...
        <table class="table bg-gray">
          ...
          @foreach($purchase->purchase_lines as $purchase_line)
            <tr>
              ...
              <td>
                {{ $purchase_line->product->name }}
                 ...
                 <div style="margin-top: 8px; font-size: 13px;">
                  ...
                  {{-- 1. Display Purchase Type --}}
                  @if( $purchase_line->purchase_type )
                    <span class="label bg-info" style="margin-right: 5px;">
                        {{ $purchase_line->purchase_type->name }}
                    </span>
                  @endif
              </td>
              <td>
              ...
              @endif
              <td style="text-align: center;"><span class="display_currency" data-currency_symbol="false">
                {{ number_format($purchase_line->quantity, 2) }}
              </span> @if(!empty($purchase_line->sub_unit)) {{$purchase_line->sub_unit->short_name}} @else {{$purchase_line->product->unit->short_name}} @endif
