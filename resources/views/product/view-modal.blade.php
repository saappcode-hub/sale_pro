	    ...
	    <div class="modal-body">
      		<div class="row">
      			...
      			<div class="col-sm-3 col-md-3 invoice-col">
				  	<?php if($product->img_path_define == 1): ?>
						<div class="thumbnail">
							<img src="<?= urldecode($product->image_url) ?>" alt="Product image">
						</div>
					<?php else: 
						$s3image = "https://piik-data.sgp1.digitaloceanspaces.com/piik-data/salepro/public/image/" . $product->business_id . '/' . $product->image;
					?>
						<div class="thumbnail">
							<img src="<?= $s3image ?>" alt="Product image">
						</div>
					<?php endif; ?>
      				<!-- <div class="thumbnail">
      					<img src="{{urldecode($product->image_url)}}" alt="Product image">
      		...
      		@elseif($product->type == 'combo' || $product->type == 'combo_single')
