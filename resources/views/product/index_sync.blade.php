            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="product_list_tab">
                        <a class="btn btn-info pull-right margin-left-10 sync_product" href="{{action([\App\Http\Controllers\ProductController::class, 'SyncProduct'])}}"><i class="fa-brands fa-pushed"></i> @lang('Push')</a>
                        @if($is_admin)
