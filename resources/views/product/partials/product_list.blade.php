        ...
        <tr>
            ...
            <div style="display: flex; width: 100%;">
                ...
                <?php
                    if ($is_admin == true) {
                        ?>
                            <button type="button" class="btn btn-xs btn-success update_product_kpi" data-type="count_kpi">Product Count KPI</button>
                            <button type="button" class="btn btn-xs bg-navy update_product_kpi" data-type="remove_kpi">Remove Product KPI</button>
                        <?php
                    }
                ?>
