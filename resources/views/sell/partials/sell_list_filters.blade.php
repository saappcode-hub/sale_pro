...
@if(empty($only) || in_array('sell_list_filter_sale_status', $only))
<div class="col-md-3">
    <div class="form-group">
        {!! Form::label('sell_list_filter_sale_status',  __('Sale Status') . ':') !!}
        {!! Form::select('sell_list_filter_sale_status', [
            'final' => __('Final'), 
            'draft' => __('Draft'), 
