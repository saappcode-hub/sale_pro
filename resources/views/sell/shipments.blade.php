        ...
        columns: [
            ...
            { data: 'payment_status', name: 'payment_status', defaultContent: ''},
            {
                ...
                render: function(data, type, row) {
                    if (!data) return '';
                    if (data === 'draft') {
                        return '<span class="status-partial">Draft</span>';
                    } else if (data === 'final') {
                        return '<span class="status-completed">Final</span>';
                    }
                    return data;
                }
            },
            { data: 'waiter', name: 'ss.first_name', defaultContent: '', @if(empty($is_service_staff_enabled)) visible: false @endif }
        ],
