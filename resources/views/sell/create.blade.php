...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	{!! Form::open(['url' => action([\App\Http\Controllers\SellPosController::class, 'store']), 'method' => 'post', 'id' => 'add_sell_form', 'files' => true ]) !!}
	 ...
	 @endif
	@if(isset($auto_load_sales_order_id) && $auto_load_sales_order_id)
		<input type="hidden" id="auto_load_sales_order_id" value="{{ $auto_load_sales_order_id }}">
	@endif

	@if(isset($auto_load_sales_order_invoice) && $auto_load_sales_order_invoice)
		<input type="hidden" id="auto_load_sales_order_invoice" value="{{ $auto_load_sales_order_invoice }}">
	@endif
	<div class="row">
			...
			@component('components.widget', ['class' => 'box-solid'])
						...
						<div class="col-sm-4">
							<div class="form-group">
								<div class="input-group">
									...
									{!! Form::select('price_group', $price_groups, $selected_price_group, ['class' => 'form-control select2', 'id' => 'price_group', 'disabled' => true]); !!}
									<span class="input-group-addon">
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						{!! Form::number('exchange_rate', $exchange_rate, ['class' => 'form-control', 'id' => 'exchange_rate', 'step' => '0.01']); !!}
					</div>
				</div>
	...
	<script type="text/javascript">
		$(document).ready( function() {
			...
			function updateTotalRiel() {
				...
				$('.total_riel').text(totalRiel.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
			}
